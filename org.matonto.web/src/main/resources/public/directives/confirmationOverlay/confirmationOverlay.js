(function() {
    ...
    angular
         ...
         * on the right. The main content for the overlay is transcluded so it can contain
         * whatever it put between the opening and closing tags. The size of the overlay can be set to 'small',
         * or 'large'.
         *
