...
(function() {
    ...
    angular
        ...
        editMappingForm.$inject = ['prefixes', 'mappingManagerService', 'mapperStateService', 'ontologyManagerService'];

        function editMappingForm(prefixes, mappingManagerService, mapperStateService, ontologyManagerService) {
            return {
                restrict: 'E',
                controllerAs: 'dvm',
                replace: true,
                ...
                controller: function() {
                    ...
                    dvm.getBaseClassName = function() {
                        ...
                        if (baseClass) {
                            return dvm.getClassName(baseClass);
                        } else {
                            return '';
                        }
                    }
                    dvm.getClassName = function(classMapping) {
                        ...
                        return dvm.om.getEntityName(dvm.om.getEntity(dvm.mm.findSourceOntologyWithClass(classId).entities, classId));
                    }
                    dvm.editConfig = function() {
                        dvm.state.displayMappingConfig = true;
                    }
                },
                templateUrl: 'modules/mapper/new-directives/editMappingForm/editMappingForm.html'
            }
        }
})();