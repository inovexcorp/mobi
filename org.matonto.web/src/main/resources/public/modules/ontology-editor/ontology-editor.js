(function() {
    ...
    angular
        .module('ontology-editor', ['file-input', 'staticIri', 'annotationTab', 'ontologyEditor', 'classEditor', 'propertyEditor', 'removeIriFromArray', 'ontologyManager', 'stateManager', 'prefixManager', 'annotationManager', 'responseObj'])
