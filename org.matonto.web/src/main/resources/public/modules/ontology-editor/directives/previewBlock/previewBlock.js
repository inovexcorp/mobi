            ...
            return {
                ...
                controller: function() {
                    ...
                    dvm.getPreview = function() {
                        ...
                        om.previewOntology(dvm.os.listItem.ontologyRecord.recordId, dvm.os.listItem.ontologyRecord.branchId, dvm.os.listItem.ontologyRecord.commitId, dvm.activePage.serialization)
