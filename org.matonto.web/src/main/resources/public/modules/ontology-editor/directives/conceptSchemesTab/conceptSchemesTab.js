...
(function() {
    ...
    angular
        ...
        conceptSchemesTab.$inject = ['stateManagerService', 'ontologyManagerService', 'prefixes'];

        function conceptSchemesTab(stateManagerService, ontologyManagerService, prefixes) {
            return {
                restrict: 'E',
                replace: true,
