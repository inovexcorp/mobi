    ...
    describe('controller methods', function() {
        describe('returns the correct tree display', function() {
            it('for pretty print', function() {
                ...
                expect(ontologyManagerSvc.getEntityName).toHaveBeenCalledWith({}, stateManagerSvc.state.type);
                expect(result).toBe(ontologyManagerSvc.getEntityName({}, stateManagerSvc.state.type));
            });
