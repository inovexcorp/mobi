...
describe('Remove Property Overlay directive', function() {
    var $compile, scope, $q, element, controller, ontologyStateSvc, ontologyManagerSvc, propertyManagerSvc, ontoUtils;
    ...
    beforeEach(function() {
        ...
        inject(function(_$compile_, _$rootScope_, _$q_, _ontologyStateService_, _ontologyManagerService_, _propertyManagerService_, _ontologyUtilsManagerService_) {
            $compile = _$compile_;
            scope = _$rootScope_;
            $q = _$q_;
