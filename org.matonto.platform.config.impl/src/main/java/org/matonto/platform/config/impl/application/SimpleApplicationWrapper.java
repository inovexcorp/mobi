...
import org.matonto.platform.config.api.application.ApplicationConfig;
import org.matonto.platform.config.api.application.ApplicationWrapper;
...
public class SimpleApplicationWrapper implements ApplicationWrapper {
    private static final String NAMESPACE = "http://matonto.org/applications#";
    protected static final String NAME = "org.matonto.platform.config.application";
