...
import com.mobi.itests.orm.ontologies.foaf.Agent;
import com.mobi.itests.orm.ontologies.foaf.AgentFactory;
import com.mobi.itests.orm.ontologies.foaf.OnlineAccountFactory;
import com.mobi.itests.orm.ontologies.foaf.OnlineChatAccount;
import com.mobi.itests.orm.ontologies.foaf.OnlineChatAccountFactory;
import com.mobi.itests.orm.ontologies.inherit.Entity;
...
public class SourceGeneratorTest {
    ...
    @Before
    public void before() {
        TEST_AGENT = valueFactory.createIRI("urn://mobi.com/orm/test/testAgent");
        TEST_ACCOUNT = valueFactory.createIRI("urn://mobi.com/orm/test/account");
        ...
        TEST_PERSON = valueFactory.createIRI("urn://mobi.com/orm/test/person");
        PERSON_CLASS = valueFactory.createIRI("http://mobi.com/ontologies/person#Person");
        NAME_PROP = valueFactory.createIRI("http://mobi.com/ontologies/person#name");
        NICKNAME_PROP = valueFactory.createIRI("http://mobi.com/ontologies/person#nickname");
        OWNS_PROP = valueFactory.createIRI("http://mobi.com/ontologies/person#owns");
        FAV_CAR_PROP = valueFactory.createIRI("http://mobi.com/ontologies/person#favoriteCar");
        TEST_CAR1 = valueFactory.createIRI("urn://mobi.com/orm/test/car1");
        TEST_CAR2 = valueFactory.createIRI("urn://mobi.com/orm/test/car2");
