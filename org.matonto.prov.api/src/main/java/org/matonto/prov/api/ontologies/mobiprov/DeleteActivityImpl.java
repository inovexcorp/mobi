...
/**
 * This implementation of the 'http://matonto.org/ontologies/prov#DeleteActivity' entity will allow developers to work in native java POJOs.
 * 
 */
public class DeleteActivityImpl
    extends ThingImpl
    implements org.matonto.ontologies.provo.Activity, _Thing, DeleteActivity, MobiProv_Thing, Thing
{


    /**
     * Construct a new DeleteActivity with the subject IRI and the backing dataset
     * 
     * @param valueConverterRegistry
     *     The ValueConversionRegistry for this DeleteActivity
     * @param backingModel
     *     The backing dataset/model of this DeleteActivity
     * @param subjectIri
     *     The subject of this DeleteActivity
     * @param valueFactory
     *     The value factory to use for this DeleteActivity
     */
    public DeleteActivityImpl(final org.matonto.rdf.api.Resource subjectIri, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConverterRegistry) {
     ...
     *     The value factory to use for this DeleteActivity
     */
    public DeleteActivityImpl(final String subjectIriStr, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConversionRegistry) {
