...
/**
 * This implementation of the 'http://matonto.org/ontologies/prov#UpdateActivity' entity will allow developers to work in native java POJOs.
 * 
 */
public class UpdateActivityImpl
    extends ThingImpl
    implements org.matonto.ontologies.provo.Activity, _Thing, MobiProv_Thing, UpdateActivity, Thing
{


    /**
     * Construct a new UpdateActivity with the subject IRI and the backing dataset
     * 
     * @param valueConverterRegistry
     *     The ValueConversionRegistry for this UpdateActivity
     * @param backingModel
     *     The backing dataset/model of this UpdateActivity
     * @param subjectIri
     *     The subject of this UpdateActivity
     * @param valueFactory
     *     The value factory to use for this UpdateActivity
     */
    public UpdateActivityImpl(final org.matonto.rdf.api.Resource subjectIri, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConverterRegistry) {
     ...
     *     The value factory to use for this UpdateActivity
     */
    public UpdateActivityImpl(final String subjectIriStr, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConversionRegistry) {
