...
/**
 * This implementation of the 'http://matonto.org/ontologies/prov#UseActivity' entity will allow developers to work in native java POJOs.
 * 
 */
public class UseActivityImpl
    extends ThingImpl
    implements org.matonto.ontologies.provo.Activity, _Thing, MobiProv_Thing, UseActivity, Thing
{


    /**
     * Construct a new UseActivity with the subject IRI and the backing dataset
     * 
     * @param valueConverterRegistry
     *     The ValueConversionRegistry for this UseActivity
     * @param backingModel
     *     The backing dataset/model of this UseActivity
     * @param subjectIri
     *     The subject of this UseActivity
     * @param valueFactory
     *     The value factory to use for this UseActivity
     */
    public UseActivityImpl(final org.matonto.rdf.api.Resource subjectIri, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConverterRegistry) {
     ...
     *     The value factory to use for this UseActivity
     */
    public UseActivityImpl(final String subjectIriStr, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConversionRegistry) {
