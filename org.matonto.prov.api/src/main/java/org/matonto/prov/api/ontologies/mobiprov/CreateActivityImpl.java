...
/**
 * This implementation of the 'http://matonto.org/ontologies/prov#CreateActivity' entity will allow developers to work in native java POJOs.
 * 
 */
public class CreateActivityImpl
    extends ThingImpl
    implements org.matonto.ontologies.provo.Activity, _Thing, CreateActivity, MobiProv_Thing, Thing
{


    /**
     * Construct a new CreateActivity with the subject IRI and the backing dataset
     * 
     * @param valueConverterRegistry
     *     The ValueConversionRegistry for this CreateActivity
     * @param backingModel
     *     The backing dataset/model of this CreateActivity
     * @param subjectIri
     *     The subject of this CreateActivity
     * @param valueFactory
     *     The value factory to use for this CreateActivity
     */
    public CreateActivityImpl(final org.matonto.rdf.api.Resource subjectIri, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConverterRegistry) {
     ...
     *     The value factory to use for this CreateActivity
     */
    public CreateActivityImpl(final String subjectIriStr, final Model backingModel, final ValueFactory valueFactory, final ValueConverterRegistry valueConversionRegistry) {
