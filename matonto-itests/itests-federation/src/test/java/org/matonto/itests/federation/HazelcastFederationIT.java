package org.matonto.itests.federation;
...
public class HazelcastFederationIT extends KarafTestSupport {
    ...
    public void hazelcastFederationStartsCorrectly() throws Exception {
        ...
        FederationService service = getOsgiService(FederationService.class, "(&(objectClass=org.matonto.federation.api.FederationService)(component.name=org.matonto.federation.hazelcast))", 5000);
