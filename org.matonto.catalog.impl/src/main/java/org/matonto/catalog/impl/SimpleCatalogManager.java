...
public class SimpleCatalogManager implements CatalogManager {
    ...
    @Override
    public PaginatedSearchResults<Record> findRecord(@NotNull Resource catalogId, @NotNull PaginatedSearchParams searchParams) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Set<Resource> getRecordIds(@NotNull Resource catalogId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Record> T createRecord(@NotNull RecordConfig config, @NotNull OrmFactory<T> factory) {
    ...
    @Override
    public <T extends Record> void addRecord(@NotNull Resource catalogId, @NotNull T record) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Record> void updateRecord(@NotNull Resource catalogId, @NotNull T newRecord) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Record> Optional<T> removeRecord(@NotNull Resource catalogId, @NotNull Resource recordId, @NotNull OrmFactory<T> factory) {
        T record = null;
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Record> Optional<T> getRecord(@NotNull Resource catalogId, @NotNull Resource recordId, @NotNull OrmFactory<T> factory) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateResource(catalogId, catalogFactory.getTypeIRI(), conn);
    ...
    @Override
    public Set<Distribution> getUnversionedDistributions(@NotNull Resource catalogId, @NotNull Resource unversionedRecordId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Distribution createDistribution(@NotNull DistributionConfig config) {
        OffsetDateTime now = OffsetDateTime.now();
    ...
    @Override
    public void addUnversionedDistribution(@NotNull Resource catalogId, @NotNull Resource unversionedRecordId,
    ...
    @Override
    public void updateUnversionedDistribution(@NotNull Resource catalogId, @NotNull Resource unversionedRecordId,
    ...
    @Override
    public void removeUnversionedDistribution(@NotNull Resource catalogId, @NotNull Resource unversionedRecordId,
            @NotNull Resource distributionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Optional<Distribution> getUnversionedDistribution(@NotNull Resource catalogId, @NotNull Resource unversionedRecordId,
            @NotNull Resource distributionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            UnversionedRecord record = utils.getRecord(catalogId, unversionedRecordId, unversionedRecordFactory, conn);
    ...
    @Override
    public Set<Version> getVersions(@NotNull Resource catalogId, @NotNull Resource versionedRecordId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Version> T createVersion(@Nonnull String title, String description, @NotNull OrmFactory<T> factory) {
        OffsetDateTime now = OffsetDateTime.now();
    ...
    @Override
    public <T extends Version> void addVersion(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull T version) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRecord record = utils.getRecord(catalogId, versionedRecordId, versionedRecordFactory, conn);
    ...
    @Override
    public <T extends Version> void updateVersion(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull T newVersion) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void removeVersion(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull Resource versionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Version> Optional<T> getVersion(@NotNull Resource catalogId, @NotNull Resource versionedRecordId,
            @NotNull Resource versionId, @NotNull OrmFactory<T> factory) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRecord record = utils.getRecord(catalogId, versionedRecordId, versionedRecordFactory, conn);
    ...
    @Override
    public <T extends Version> Optional<T> getLatestVersion(@NotNull Resource catalogId, @NotNull Resource versionedRecordId,
            @NotNull OrmFactory<T> factory) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRecord record = utils.getRecord(catalogId, versionedRecordId, versionedRecordFactory, conn);
    ...
    @Override
    public Commit getTaggedCommit(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull Resource versionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Set<Distribution> getVersionedDistributions(@NotNull Resource catalogId, @NotNull Resource versionedRecordId,
            @NotNull Resource versionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            Version version = utils.getVersion(catalogId, versionedRecordId, versionId, versionFactory, conn);
    ...
    @Override
    public void addVersionedDistribution(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull Resource versionId,
            @NotNull Distribution distribution) {
        try (RepositoryConnection conn = repository.getConnection()) {
            Version version = utils.getVersion(catalogId, versionedRecordId, versionId, versionFactory, conn);
            if (conn.containsContext(distribution.getResource())) {
    ...
    @Override
    public void updateVersionedDistribution(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull Resource versionId,
            @NotNull Distribution newDistribution) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateVersionedDistribution(catalogId, versionedRecordId, versionId, newDistribution.getResource(), conn);
            conn.begin();
            utils.updateObject(newDistribution, conn);
            conn.commit();
        }
    ...
    @Override
    public void removeVersionedDistribution(@NotNull Resource catalogId, @NotNull Resource versionedRecordId, @NotNull Resource versionId,
            @NotNull Resource distributionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Optional<Distribution> getVersionedDistribution(@NotNull Resource catalogId, @NotNull Resource recordId, @NotNull Resource versionId,
            @NotNull Resource distributionId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Set<Branch> getBranches(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public <T extends Branch> T createBranch(@Nonnull String title, String description, @NotNull OrmFactory<T> factory) {
        OffsetDateTime now = OffsetDateTime.now();
    ...
    @Override
    public <T extends Branch> void addBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull T branch) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRDFRecord record = utils.getRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory, conn);
    ...
    @Override
    public void addMasterBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRDFRecord record = utils.getRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory, conn);
            conn.begin();
    ...
    @Override
    public <T extends Branch> void updateBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull T newBranch) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void updateHead(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource branchId, @NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void removeBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource branchId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            Branch branch = utils.getBranch(catalogId, versionedRDFRecordId, branchId, branchFactory, conn);
            IRI masterBranchIRI = vf.createIRI(VersionedRDFRecord.masterBranch_IRI);
    ...
    @Override
    public <T extends Branch> Optional<T> getBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId,
            @NotNull Resource branchId, @NotNull OrmFactory<T> factory) {
        try (RepositoryConnection conn = repository.getConnection()) {
            VersionedRDFRecord record = utils.getRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory, conn);
    ...
    @Override
    public Branch getMasterBranch(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public InProgressCommit createInProgressCommit(@NotNull User user) {
    ...
    @Override
    public void updateInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource commitId,                                       @Nullable Model additions, @Nullable Model deletions) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void updateInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull User user,                                       @Nullable Model additions, @Nullable Model deletions) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void addInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId,
            @NotNull InProgressCommit inProgressCommit) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Optional<Commit> getCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId,
            @NotNull Resource branchId, @NotNull Resource commitId) {
    ...
    @Override
    public Commit getHeadCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource branchId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateBranch(catalogId, versionedRDFRecordId, branchId, conn);
    ...
    @Override
    public Optional<InProgressCommit> getInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId,
            @NotNull User user) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory.getTypeIRI(), conn);
    ...
    @Override
    public Optional<InProgressCommit> getInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId,
            @NotNull Resource inProgressCommitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory.getTypeIRI(), conn);
    ...
    @Override
    public Revision getRevision(@NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Difference getRevisionChanges(@NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Difference getCommitDifference(@NotNull Resource commitId) {
        long start = System.currentTimeMillis();
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateResource(commitId, commitFactory.getTypeIRI(), conn);
    ...
    @Override
    public void removeInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource            inProgressCommitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public void removeInProgressCommit(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull User user) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateRecord(catalogId, versionedRDFRecordId, versionedRDFRecordFactory.getTypeIRI(), conn);
            InProgressCommit commit = utils.getInProgressCommit(versionedRDFRecordId, user.getResource(), conn);
            conn.begin();
    ...
    @Override
    public Model applyInProgressCommit(@NotNull Resource inProgressCommitId, @NotNull Model entity) {
        long start = System.currentTimeMillis();
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public List<Commit> getCommitChain(@NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateResource(commitId, commitFactory.getTypeIRI(), conn);
    ...
    @Override
    public List<Commit> getCommitChain(@NotNull Resource catalogId, @NotNull Resource versionedRDFRecordId, @NotNull Resource branchId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            Branch branch = utils.getBranch(catalogId, versionedRDFRecordId, branchId, branchFactory, conn);
            Resource head = utils.getHeadCommitIRI(branch);
    ...
    @Override
    public Model getCompiledResource(@NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
            utils.validateResource(commitId, commitFactory.getTypeIRI(), conn);
    ...
    @Override
    public Model getCompiledResource(@NotNull Resource versionedRDFRecordId, @NotNull Resource branchId, @NotNull Resource commitId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Set<Conflict> getConflicts(@NotNull Resource leftId, @NotNull Resource rightId) {
        try (RepositoryConnection conn = repository.getConnection()) {
    ...
    @Override
    public Difference getDiff(@NotNull Model original, @NotNull Model changed) {
