...
public interface DatasetManager {
     ...
     * @return An {@link Optional} containing the DatasetRecord that was removed or {@link Optional#EMPTY} if no record
     *         was     *         removed.
     * @throws IllegalArgumentException if the DatasetRecord could not be found in the catalog.
     */
    Optional<DatasetRecord> deleteDataset(Resource dataset, String repositoryId);
     ...
     */
    Optional<DatasetRecord> deleteDataset(Resource record);
     ...
     * @throws IllegalArgumentException if the DatasetRecord could not be found in the catalog.
     */
    Optional<DatasetRecord> safeDeleteDataset(Resource dataset, String repositoryId);
     ...
     * @throws IllegalStateException if the DatasetRecord does not point to a Dataset or a repository
     */
    Optional<DatasetRecord> safeDeleteDataset(Resource record);
