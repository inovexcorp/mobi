...
import org.matonto.persistence.utils.api.RDFHandler;
...
public class BatchExporter implements RDFHandler {
    ...
    @Override
    public void startRDF() throws org.matonto.persistence.utils.exception.RDFHandlerException {
        delegate.startRDF();
    }
    ...
    @Override
    public void handleComment(String comment) throws org.matonto.persistence.utils.exception.RDFHandlerException {
