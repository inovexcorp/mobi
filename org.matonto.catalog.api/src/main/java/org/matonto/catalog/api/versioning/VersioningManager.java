...
public interface VersioningManager {
    ...
    /**
     * Commits the {@link org.matonto.catalog.api.ontologies.mcat.InProgressCommit} for the provided {@link User} to
     * the {@link org.matonto.catalog.api.ontologies.mcat.Branch} identified by the provided Resource IDs with the
     * provided message.
     *
     * @param catalogId The Resource identifying the Catalog which contains the Record.
    ...
    /**
     * Merges a {@link org.matonto.catalog.api.ontologies.mcat.Branch} identified by the provided Resources into
     * another Branch identified by the provided Resources. Both Branches must belong to the same
     * {@link org.matonto.catalog.api.ontologies.mcat.VersionedRDFRecord}. The provided addition and deletion
     * {@link Model Models} should resolve any conflicts and will be used to create the merge
     * {@link org.matonto.catalog.api.ontologies.mcat.Commit} which will be associated with the provided {@link User}.
