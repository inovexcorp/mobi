...
public enum SimpleClassExpressionType 
{
	OWL_CLASS("Class"), 
	...
	private SimpleClassExpressionType(@Nonnull String name) 
	{
		this.name = name;
	...
	public static SimpleClassExpressionType matontoClassExpressionType(ClassExpressionType owlapiCEType)
	{
		return SimpleClassExpressionType.valueOf(owlapiCEType.getName());
	}
	
	
	public static ClassExpressionType owlapiClassExpressionType(SimpleClassExpressionType matontoCEType)
	{
		return ClassExpressionType.valueOf(matontoCEType.getName());
	}
