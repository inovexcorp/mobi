...
public class MobiContextCollector extends AbstractQueryModelVisitor<Exception> {
    ...
    private MobiContextCollector() {
    }

    protected static Map<TupleExpr, Var> collectContexts(TupleExpr theTupleExpr) throws Exception {
        MobiContextCollector aContextVisitor = new MobiContextCollector();
