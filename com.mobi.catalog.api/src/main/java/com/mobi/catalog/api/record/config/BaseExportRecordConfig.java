...
public class BaseExportRecordConfig {
    private OutputStream output;
    private RDFFormat format;

    protected BaseExportRecordConfig(Builder builder) {
    ...
    public static class Builder {
        ...
        public BaseExportRecordConfig build() throws IOException {
            return new BaseExportRecordConfig(this);
        }
    }
}
