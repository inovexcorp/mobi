...
public class RDFExportRecordConfig extends BaseExportRecordConfig {
    private String subj;
    private String pred;
    ...
    protected RDFExportRecordConfig(Builder builder) {
        super(builder);
    ...
    public static class Builder extends BaseExportRecordConfig.Builder {
        ...
        public RDFExportRecordConfig build() {
            return new RDFExportRecordConfig(this);
        }
    }
}
