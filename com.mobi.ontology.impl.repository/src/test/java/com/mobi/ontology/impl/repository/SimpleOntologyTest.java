...
//        ontology = new SimpleOntology(ont3Model, repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
...
//        Ontology ont3 = new SimpleOntology(Models.createModel(stream3, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
...
//        Ontology ont2 = new SimpleOntology(ont2Model, repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
...
//        Ontology dcterms = new SimpleOntology(dctermsModel, repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
...
//        ont1 = new SimpleOntology(Models.createModel(stream1, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
//
//        InputStream streamQueryOntology = this.getClass().getResourceAsStream("/test-ontology.ttl");
//        queryOntology = new SimpleOntology(Models.createModel(streamQueryOntology, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
//
//        InputStream streamQueryVocabulary = this.getClass().getResourceAsStream("/test-vocabulary.ttl");
//        queryVocabulary = new SimpleOntology(Models.createModel(streamQueryVocabulary, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
//
//        InputStream streamOnlyDeclared = this.getClass().getResourceAsStream("/only-declared.ttl");
//        onlyDeclared = new SimpleOntology(Models.createModel(streamOnlyDeclared, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
//    }
//
//    @Test
...
//        Ontology ont = new SimpleOntology(Models.createModel(stream, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, bNodeService, vf, mf, importService);
...
//        Ontology listOntology = new SimpleOntology(Models.createModel(stream, transformer), repo, ontologyManager, catalogManager, catalogConfigProvider, datasetManager, importsResolver, transformer, blankNodeService, vf, mf, importService);
//
