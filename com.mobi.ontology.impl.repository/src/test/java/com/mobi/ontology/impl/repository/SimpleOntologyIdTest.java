...
public class SimpleOntologyIdTest extends OrmEnabledTestCase  {
    ...
    public void setUp() {
        ...
        when(settingService.getSettingByType(DefaultOntologyNamespaceApplicationSetting.class)).thenReturn(Optional.empty());
    ...
    public void testConstructorWithNoInputValue() {
        ...
        assertTrue(ontologyId.getOntologyIdentifier().stringValue().startsWith(SimpleOntologyId.FALLBACK_ONTOLOGY_NAMESPACE));
