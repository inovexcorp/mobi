...
describe('Overview Tab directive', function() {
    ...
    beforeEach(function() {
        ...
        element = $compile(angular.element('<overview-tab></overview-tab>'))(scope);
        scope.$digest();
    });
    ...
    describe('replaces the element with the correct html', function() {
        it('for wrapping containers', function() {
            ...
            expect(element.hasClass('overview-tab')).toBe(true);
            expect(element.hasClass('row')).toBe(true);
        });
        it('with a association-block', function() {
            expect(element.find('association-block').length).toBe(1);
        });
