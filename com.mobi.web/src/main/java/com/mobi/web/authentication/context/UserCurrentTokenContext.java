...
@Component(
        provide = { UserCurrentTokenContext.class, HttpContext.class },
        properties = {
                ExtenderConstants.PROPERTY_HTTP_CONTEXT_ID + "=" + UserCurrentTokenContext.CONTEXT_ID
        }
)
public class UserCurrentTokenContext extends AuthHttpContext {

    private final Logger log = LoggerFactory.getLogger(this.getClass().getName());
    public static final String CONTEXT_ID = "userCurrentCtxId";

    @Activate
    void setup(BundleContext context) {
        log.trace("Starting UserCurrentTokenContext");
