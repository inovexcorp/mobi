...
(function() {
    ...
    const mergeRequestViewComponent = {
        templateUrl: 'merge-requests/components/mergeRequestView/mergeRequestView.component.html',
        bindings: {},
        controllerAs: 'dvm',
        controller: mergeRequestViewComponentCtrl
    };

    mergeRequestViewComponent.$inject = ['$q', 'mergeRequestManagerService', 'mergeRequestsStateService', 'utilService', 'modalService', 'ontologyStateService', 'ontologyManagerService'];
