...
(function() {
    ...
    const editRequestOverlayComponent = {
        templateUrl: 'merge-requests/components/editRequestOverlay/editRequestOverlay.component.html',
        bindings: {
            close: '&',
            dismiss: '&'
        },
    ...
    editRequestOverlayComponent.$inject = ['mergeRequestsStateService', 'mergeRequestManagerService', 'catalogManagerService', 'userManagerService', 'utilService', 'prefixes'];
