        ...
        return {
            ...
            link: function(scope, element, jsonld) {
                ...
                */
                 ...
                 */
                var formattedData = d3TransformerService.buildForceDirectedGraphD3Format(jsonld);
                var svgGetter = document.querySelectorAll("svg");
                var svg = d3.select(svgGetter[0]);
                ...
                scope.$watchCollection('graphData', draw);
                ...
                function nodesMouseOut(nodesMouseOutConfig) {
                    nodes.on('mouseout', element => {
                        ...
                        svg.style('cursor', nodesMouseOutConfig.cursor);
                        d3.select(this).select('circle')
            ...
            templateUrl: 'directives/rdfVisualization/rdfVisualization.html'
        }
    }
})();
