...
describe('Concept Schemes Tab component', function() {
    ...
    beforeEach(function() {
        ...
        mockComponent('ontology-editor', 'conceptSchemeHierarchyBlock');
        mockComponent('ontology-editor', 'annotationBlock');
        mockComponent('ontology-editor', 'datatypePropertyBlock');
        mockComponent('ontology-editor', 'objectPropertyBlock');
    ...
    describe('contains the correct html', function() {
        ...
        it('with a data-property-block depending on whether the selected entity is a concept', function() {
            ...
            scope.$digest();
            expect(this.element.find('datatype-property-block').length).toEqual(0);

            ontologyManagerSvc.isConcept.and.returnValue(true);
            scope.$digest();
            expect(this.element.find('datatype-property-block').length).toEqual(1);
        })
