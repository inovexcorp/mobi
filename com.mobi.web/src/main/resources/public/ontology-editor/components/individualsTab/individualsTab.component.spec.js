...
describe('Individuals Tab component', function() {
    ...
    beforeEach(function() {
        ...
        mockComponent('ontology-editor', 'individualHierarchyBlock');
    ...
    describe('contains the correct html', function() {
        it('for wrapping containers', function() {
            expect(this.element.prop('tagName')).toEqual('INDIVIDUALS-TAB');
            expect(this.element.querySelectorAll('.individuals-tab.row').length).toEqual(1);
        });
