...
const template = require('./relationshipsBlock.component.html');
...
function relationshipsBlockComponentCtrl(ontologyManagerService, ontologyStateService, ontologyUtilsManagerService, modalService, prefixes) {
    ...
    dvm.hasTopConceptProperty = function() {
        return !isEmpty(dvm.os.getEntityByRecordId(dvm.os.listItem.ontologyRecord.recordId, prefixes.skos + 'hasTopConcept', dvm.os.listItem));
    }
...
export default relationshipsBlockComponent;