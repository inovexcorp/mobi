...
(function() {
     ...
     * a text input for the individual name (which populates the {@link staticIri.directive:staticIri IRI}) and
    ...
    const createIndividualOverlayComponent = {
        templateUrl: 'ontology-editor/components/createIndividualOverlay/createIndividualOverlay.component.html',
         bindings: {
            close: '&',
            dismiss: '&'
        },
