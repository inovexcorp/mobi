...
(function() {
    ...
    const characteristicsBlockComponent = {
        templateUrl: 'ontology-editor/components/characteristicsBlock/characteristicsBlock.component.html',
        bindings: {
            iri: '<',
            types: '<',
            updateTypes: '&'
    ...
    function characteristicsBlockComponentCtrl(prefixes, ontologyStateService, ontologyManagerService, ontologyUtilsManagerService) {
        ...
        dvm.onChange = function(characteristicObj, value) {
            ...
            if (characteristicObj.checked) {
                ...
                _.pull(types, characteristicObj.typeIRI);
        ...
        function removeTypeFrom(object, typeToRemove) {
            _.pull(_.get(object, '@type', []), typeToRemove);
        }

        function setVariables() {
            _.forEach(dvm.characteristics, obj => {
                obj.checked = _.includes(dvm.types, obj.typeIRI);
            });
        }
    }
