...
(function() {
    ...
    const iriSelectOntologyComponent = {
        templateUrl: 'ontology-editor/components/iriSelectOntology/iriSelectOntology.component.html',
        bindings: {
            bindModel: '<',
            selectList: '<',
            displayText: '<',
    ...
    function iriSelectOntologyComponentCtrl(ontologyStateService, ontologyUtilsManagerService) {
        ...
        dvm.$onChanges = function() {
            dvm.isMultiSelect = angular.isDefined(dvm.multiSelect) ? dvm.multiSelect : true;
        }
