...
describe('Datasets Ontology Picker component', function() {
    ...
    beforeEach(function() {
        ...
        catalogManagerStub.getRecords.and.callFake(() => of(new HttpResponse({body: []})));
    });
    ...
    describe('controller methods', function() {
        ...
        describe('should set the list of ontologies', function() {
            ...
            it('successfully', fakeAsync(function() {
                catalogManagerStub.getRecords.and.callFake(() => of(new HttpResponse({body: [ontology1Record, ontology2Record]})));
                component.selected = [{
