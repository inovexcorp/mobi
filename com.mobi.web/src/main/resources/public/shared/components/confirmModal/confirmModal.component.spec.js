...
describe('Confirm Modal component', function() {
    ...
    beforeEach(function() {
        ...
        scope.$digest();
        this.controller = this.element.controller('confirmModal');
    });
    ...
    describe('controller bound variable', function() {
        it('resolve should be one way bound', function() {
            this.controller.resolve = {body: ''};
            scope.$digest();
            expect(scope.resolve).toEqual({});
        });
        it('close should be called in parent scope', function() {
            this.controller.close();
            expect(scope.close).toHaveBeenCalled();
        });
        it('dismiss should be called in parent scope', function() {
