...
const template = require('./confirmModal.component.ajs.html');

/**
 * @ngdoc component
 * @name shared.component:confirmModalAjs
 *
 * @description
 * `confirmModalAjs` is a component that creates content for a modal that will confirm or deny an action
