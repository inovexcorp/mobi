 ...
 * #L%
 */
fdescribe('Error Display component', function() {
    var $compile, scope;
    ...
    describe('contains the correct html', function() {
        it('for wrapping-containers', function() {
            expect(this.element.prop('tagName')).toEqual('ERROR-DISPLAY');
            expect(this.element.querySelectorAll('.error-display').length).toEqual(1);
        });
