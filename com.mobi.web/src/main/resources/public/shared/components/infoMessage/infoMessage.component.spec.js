 ...
 * #L%
 */
fdescribe('Info Message component', function() {
    var $compile, scope;
    ...
    describe('contains the correct html', function() {
        it('for wrapping-containers', function() {
            expect(this.element.prop('tagName')).toEqual('INFO-MESSAGE');
            expect(this.element.querySelectorAll('.info-message').length).toEqual(1);
            expect(this.element.querySelectorAll('.text-info').length).toEqual(1);
        });
