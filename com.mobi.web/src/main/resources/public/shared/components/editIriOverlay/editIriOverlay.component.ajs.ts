...
const template = require('./editIriOverlay.component.ajs.html');
 ...
 */
const editIriOverlayComponentAjs = {
    template,
    bindings: {
        resolve: '<',
        close: '&',
    ...
    controllerAs: 'dvm',
    controller: editIriOverlayComponentCtrlAjs
};

editIriOverlayComponentCtrlAjs.$inject = ['REGEX'];

function editIriOverlayComponentCtrlAjs(REGEX) {
    var dvm = this;
...
export default editIriOverlayComponentAjs;
