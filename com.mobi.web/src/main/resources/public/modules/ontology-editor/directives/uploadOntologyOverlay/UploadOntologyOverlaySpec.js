...
describe('Upload Ontology Overlay directive', function() {
    ...
    describe('controller methods', function() {
        describe('submit should call the correct method and set the values correctly if the adjusted controller.index is', function() {
            beforeEach(function() {
            ...
            it('less than controller.total', function() {
                this.controller.total = 2;
