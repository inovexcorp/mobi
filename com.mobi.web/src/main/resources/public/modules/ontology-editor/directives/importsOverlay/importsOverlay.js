                ...
                controller: function() {
                    ...
                    dvm.confirmed = function(urls) {
                        ...
                        os.saveChanges(os.listItem.ontologyRecord.recordId, {additions: os.listItem.additions, deletions: os.listItem.deletions})
                            ...
                            .then(() => os.updateOntology(os.listItem.ontologyRecord.recordId, os.listItem.ontologyRecord.branchId, os.listItem.ontologyRecord.commitId, os.listItem.ontologyRecord.type, os.listItem.upToDate, os.listItem.inProgressCommit), $q.reject)
                            .then(() => {
