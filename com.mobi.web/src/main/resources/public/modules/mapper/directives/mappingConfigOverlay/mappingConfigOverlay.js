...
(function() {
    ...
    angular
        ...
        .component('mappingConfigOverlay', {
            ...
            controllerAs: 'dvm',
            controller: ['$q', 'utilService', 'ontologyManagerService', 'mapperStateService', 'mappingManagerService', 'catalogManagerService', 'prefixes', MappingConfigOverlayController],
            templateUrl: 'modules/mapper/directives/mappingConfigOverlay/mappingConfigOverlay.html'
        });

        function MappingConfigOverlayController($q, utilService, ontologyManagerService, mapperStateService, mappingManagerService, catalogManagerService, prefixes) {
            var dvm = this;
