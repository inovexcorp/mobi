...
(function() {
    ...
    const newInstanceClassOverlayComponent = {
        templateUrl: 'discover/explore/components/newInstanceClassOverlay/newInstanceClassOverlay.component.html',
        bindings: {
            close: '&',
            dismiss: '&',
            resolve: '<'
    ...
    newInstanceClassOverlayComponent.$inject = ['$timeout', '$filter', 'uuid', 'discoverStateService', 'exploreService', 'utilService'];
    ...
    angular.module('explore')
        .component('newInstanceClassOverlay', newInstanceClassOverlayComponent);
})();