...
describe('Instance Form component', function() {
    ...
    beforeEach(function() {
        ...
        this.element = $compile(angular.element('<instance-form header="header" is-valid="isValid" change-event="changeEvent(value)"></instance-form>'))(scope);
        scope.$digest();
    ...
    describe('contains the correct html', function() {
        it('for wrapping containers', function() {
            expect(this.element.prop('tagName')).toBe('INSTANCE-FORM');
        });
    ...
    describe('controller methods', function() {
        ...
        it('getMissingProperties retrieves the proper list of messages', function() {
            ...
            expect(scope.changeEvent).toHaveBeenCalledWith(this.controller.isValid);
        });
