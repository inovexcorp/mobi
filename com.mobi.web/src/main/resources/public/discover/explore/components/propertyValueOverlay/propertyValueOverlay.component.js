...
(function() {
    ...
    const propertyValueOverlayComponent = {
        templateUrl: 'discover/explore/components/propertyValueOverlay/propertyValueOverlay.component.html',
        bindings: {
            close: '&',
            dismiss: '&',
            resolve: '<'
    ...
    propertyValueOverlayComponent.$inject = ['discoverStateService', 'prefixes', 'uuid', 'utilService', 'exploreUtilsService', 'modalService'];

    function propertyValueOverlayComponentCtrl(discoverStateService, prefixes, uuid, utilService, exploreUtilsService, modalService) {
        var dvm = this;
    ...
    angular.module('explore')
        .component('propertyValueOverlay', propertyValueOverlayComponent);
})();