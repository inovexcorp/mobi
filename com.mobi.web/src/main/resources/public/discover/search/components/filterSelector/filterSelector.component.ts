...
const template = require('./filterSelector.component.html');
...
filterSelectorComponentCtrl.$inject = ['utilService', 'prefixes'];
...
function filterSelectorComponentCtrl(utilService, prefixes) {
    ...
    dvm.needsOneInput = function() {
        return includes(needsOneInput, dvm.filterType);
    }
