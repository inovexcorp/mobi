 ...
 * #L%
 */
import './sparqlResultBlock.component.scss';

const template = require('./sparqlResultBlock.component.html');
...
sparqlResultBlockComponentCtrl.$inject = ['sparqlManagerService', 'modalService'];
...
export default sparqlResultBlockComponent;