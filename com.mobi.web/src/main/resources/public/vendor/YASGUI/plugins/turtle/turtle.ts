...
import * as faCubeIcon from "@fortawesome/free-solid-svg-icons/faCube";
...
export default class Turtle implements Plugin<PlugingConfig> {
    ...
    public label = "Turtle";
    public getIcon() {
        return drawSvgStringAsElement(drawFontAwesomeIconAsSvg(faCubeIcon));
    }
    ...
    draw() {
        ...
        if (mode === "turtle") {
            codemirrorOpts['mode'] = { name: "turtle" };
        }

        // testing purpose.

        codemirrorOpts['mode']  = 'text/turtle';
