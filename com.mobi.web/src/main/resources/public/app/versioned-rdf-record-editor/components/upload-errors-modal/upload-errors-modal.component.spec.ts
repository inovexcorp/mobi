...
import { UploadErrorsModalComponent } from './upload-errors-modal.component';

describe('Upload Errors Overlay component', function() {
  let component: UploadErrorsModalComponent;
  let element: DebugElement;
  let fixture: ComponentFixture<UploadErrorsModalComponent>;
  let matDialogRef: jasmine.SpyObj<MatDialogRef<UploadErrorsModalComponent>>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(UploadErrorsModalComponent);
    component = fixture.componentInstance;
    element = fixture.debugElement;
    matDialogRef = TestBed.inject(MatDialogRef) as jasmine.SpyObj<MatDialogRef<UploadErrorsModalComponent>>;
  });
