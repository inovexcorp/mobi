...
describe('Create Branch Overlay component', function() {
    ...
    beforeEach(function() {
        ...
        matDialogRef = TestBed.inject(MatDialogRef) as jasmine.SpyObj<MatDialogRef<CreateBranchOverlayComponent>>;
        ontologyStateServiceStub = TestBed.inject(OntologyStateService) as jasmine.SpyObj<OntologyStateService>;
        catalogManagerServiceStub = TestBed.inject(CatalogManagerService) as jasmine.SpyObj<CatalogManagerService>;
