...
/**
 * @class CreateIndividualOverlayComponent
 *
 ...
 * individual name (which populates the {@link StaticIriComponent} IRI) and a
 * {@link OntologyClassSelectComponent} for the classes this individual will be an instance of. Meant to
