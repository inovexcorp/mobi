...
describe('Visualization Class List component', () => {
    ...
    beforeEach(async () => {
        cru1 = { type: ControlRecordType.NODE, id: '0.0', name: 'A',  isImported: undefined,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cru2 = { type: ControlRecordType.NODE, id: '0.1', name: undefined,  isImported: undefined,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cr1 = { type: ControlRecordType.NODE, id: '1.1', name: 'A',  isImported: false,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cr21 = { type: ControlRecordType.NODE, id: '2.1', name: 'A',  isImported: true,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cr22 = { type: ControlRecordType.NODE, id: '2.2', name: 'B',  isImported: true,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cr41 = { type: ControlRecordType.NODE, id: '4.1', name: 'A',  isImported: true,  ontologyId: 'ontologyId', onGraph: true, disabled: false};
        cr410 = { type: ControlRecordType.NODE, id: '4.10', name: 'Z',  isImported: true,  ontologyId: 'ontologyId', onGraph: true, disabled: false, isChecked: false};
