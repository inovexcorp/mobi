...
export interface GraphStateI {
  inProgressCommit?: inProgressCommitI;
  commitId: string;
  ontologyId: string;
  recordId: string;
...
/**
 * Represents the state of a graph, including nodes, edges, ontologies, and display properties.
 * This class is responsible for managing graph data, filtering nodes and edges, and saving graph states.
 */
export class GraphState implements GraphStateI {
  ...
  public saveGraphStateI(graphStateI: GraphStateI): void {
    this.inProgressCommit = graphStateI.inProgressCommit;
