...
/**
 * AuthenticationHomeGuard is a route guard that protects routes from unauthorized access
 * by checking the user's authentication status. If the user is not authenticated,
 * they are redirected to the login page.
 */
@Injectable()
export class AuthenticationHomeGuard implements CanActivate {
    ...
    canActivate(): Observable<boolean> {
        return this.loginManagerService.validateSession(false);
    }
}
