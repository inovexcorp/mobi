  ...
  describe('controller methods', function () {
    ...
    describe('should update a dataset', function () {
      ...
      describe('successfully', function () {
        beforeEach(function () {
          datasetManagerStub.updateDatasetRecord.and.returnValue(of(null));
        });
        ...
        it('when an ontology is added.', fakeAsync(function () {
          ...
          component.update();
          tick();
          expect(catalogManagerStub.getRecordBranch).toHaveBeenCalledWith('master', 'newOntology', catalogId);
