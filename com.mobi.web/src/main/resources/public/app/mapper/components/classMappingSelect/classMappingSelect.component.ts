...
/**
 * @class ClassMappingSelectComponent
 *
...
export class ClassMappingSelectComponent implements OnInit, OnChanges {
  ...
  confirmDelete(classMapping: JSONLDObject): void {
    ...
    this.dialog.open(ConfirmModalComponent, {
      data: {
        content: `<p>Are you sure you want to delete <strong>${getEntityName(classMapping)}</strong>?</p><p class="form-text">Deleting a class will remove any properties that link to it.</p>`
      }
