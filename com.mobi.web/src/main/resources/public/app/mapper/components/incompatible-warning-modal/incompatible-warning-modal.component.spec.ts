...
describe('IncompatibleWarningModalComponent', () => {
    ...
    describe('contains the correct html', () => {
        ...
        it('if there are  incompatible class & property mappings', () => {
            ...
            const buttons = element.queryAll(By.css('small'));
            expect(buttons.length).toEqual(3);
            expect(buttons[0].nativeElement.textContent.trim()).toContain('http://matonto.org/ontologies/uhtc#Element');
            expect(buttons[1].nativeElement.textContent.trim()).toContain('http://matonto.org/ontologies/uhtc#symbol');
            expect(buttons[2].nativeElement.textContent.trim()).toContain('http://matonto.org/ontologies/uhtc#element');
        });
    });
