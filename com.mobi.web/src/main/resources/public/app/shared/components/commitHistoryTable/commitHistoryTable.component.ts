...
export class CommitHistoryTableComponent implements OnInit, OnChanges, OnDestroy {
    ...
    constructor(private util: UtilService, private cm: CatalogManagerService,
        private dialog: MatDialog, private spinnerSvc: ProgressSpinnerService, public um: UserManagerService) {
    }
