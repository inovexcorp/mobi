...
describe('Util service', function() {
    ...
    beforeEach(async () => {
        ...
        beautifyStub = TestBed.inject(BeautifyPipe) as jasmine.SpyObj<BeautifyPipe>;
    ...
    describe('should create a rejected promise with an error object', function() {
        beforeEach(function() {
            spyOn(service, 'getErrorDataObject').and.returnValue({error: '', errorMessage: 'test', errorDetails: []});
        });
        it('unless the response was canceled', fakeAsync(function() {
