...
describe('Ontology State Service', function() {
  ...
  describe('saveCurrentChanges should call the proper methods when', function() {
    beforeEach(function() {
      service.listItem = listItem;
      spyOn(service, 'setEntityUsages');
      spyOn(VersionedRdfState.prototype, 'saveCurrentChanges').and.returnValue(of(null));
    });
    it('getActiveKey is not project and getActiveEntityIRI is defined', fakeAsync(function() {
      const id = 'id';
      ...
      tick();
      expect(VersionedRdfState.prototype.saveCurrentChanges).toHaveBeenCalledWith(service.listItem);
