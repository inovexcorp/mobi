...
const template = require('./sortOptions.component.html');
 ...
 * from the {@link shared.service:catalogManagerService}. The `sortOption` will be the value of the select,
 ...
 * {@link shared.service:catalogManagerService}
 */
