...
const template = require('./limitDescription.component.html');
...
function limitDescriptionComponentCtrl() {
    ...
    function getLimitedDescription() {
        return truncate(dvm.description, {length: dvm.descriptionLimit});
    }
}

export default limitDescriptionComponent;
