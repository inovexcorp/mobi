...
(function() {
    ...
    angular
         ...
         * `row` with {@link shared.component:block blocks} for editing the selecting and previewing a mapping.
         */
         ...
         * {@link shared.service:mapperStateService#mapping mapping}. The right column contains a
