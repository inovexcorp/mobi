...
describe('File Upload Page component', function() {
    ...
    describe('controller methods', function() {
        ...
        it('should get the name of a data mapping', function() {
            ...
            expect(_.isString(this.controller.getDataMappingName('dataMapping'))).toEqual(true);
        ...
        describe('should set the correct state for continuing to edit a mapping', function() {
            ...
            it('if a new mapping is being created', function() {
                ...
                expect(mapperStateSvc.selectedClassMappingId).toEqual(this.classMapping['@id']);
                expect(mapperStateSvc.setProps.calls.count()).toEqual(this.classMappings.length);
                expect(mapperStateSvc.step).toEqual(mapperStateSvc.editMappingStep);
    ...
    describe('contains the correct html', function() {
        it('for wrapping containers', function() {
            expect(this.element.prop('tagName')).toEqual('FILE-UPLOAD-PAGE');
            expect(this.element.querySelectorAll('.file-upload-page').length).toEqual(1);
        ...
        ['file-upload-form', 'preview-data-grid'].forEach(test => {
        ...
        it('depending on whether there are invalid columns', function() {
            ...
            expect(invalidProps.querySelectorAll('ul li').length).toEqual(mapperStateSvc.invalidProps.length);
        });
    });
