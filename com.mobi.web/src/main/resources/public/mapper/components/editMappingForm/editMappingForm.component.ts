...
import './editMappingForm.component.scss';

const template = require('./editMappingForm.component.html');
...
function editMappingFormComponentCtrl(mapperStateService, mappingManagerService, utilService, modalService) {
    ...
    dvm.getEntityName = function(id) {
        return dvm.util.getDctermsValue(find(dvm.state.mapping.jsonld, {'@id': id}), 'title');
    }
...
export default editMappingFormComponent;