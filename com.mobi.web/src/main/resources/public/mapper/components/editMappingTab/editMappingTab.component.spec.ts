...
import { MatButtonModule, MatButtonToggleModule, MatDialog, MatIconModule, MatMenuModule } from '@angular/material';
...
describe('Edit Mapping Tab component', function() {
    ...
    beforeEach(function() {
        mapperStateStub = TestBed.get(MapperStateService); // Done first to avoid reading properties of undefined
