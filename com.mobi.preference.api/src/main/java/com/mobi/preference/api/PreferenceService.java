...
public interface PreferenceService {
    ...
    /**
     * Get all instances of Preference for a particular user. Preferences will include all referenced object values.
     *
    ...
    /**
     * Get the instance of Preference for a user that is of the type of the passed in preferenceType. Preference will
     * include all referenced object values.
     *
    ...
    /**
     * Add the associated preference instance to the repo for the passed in user. Additionally, add the object value
     * for the preference to the repo if one exists.
     *
    ...
    /**
     * Removes the Preference of the passed in preferenceType for a user. Referenced Entities will only be removed if
     * not referenced by another Preference.
     *
     * @param user           The {@link User} whose {@link Preference} will be deleted.
     * @param preferenceType The type of {@link Preference} to remove.
     */
    void deletePreference(User user, Resource preferenceType);

    /**
     * Removes a Preference identified by its IRI from the repo. Referenced Entities will only be removed if not
     * referenced by another Preference.
     *
