...
public class PackageNamer {
	 ...
	 *             If the IRI is malformed, doesn't match our pattern
	 */
	 ...
	 * 
	 * @param elements
	 *            The {@link List} of current package name elements
	 ...
	 * 
	 * @param coll
	 *            The input list of {@link String}s with potential empty values
	 * @param reverse
	 *            Whether or not to reverse the order of the provided elements
