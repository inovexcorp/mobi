...
public interface Thing {
	 ...
	 * 
	 * @param predicate
	 *            The predicate identifying the property
	 * @param context
	 *            The context {@link IRI}
	 ...
	 * 
	 * @param predicate
	 *            The {@link IRI} of the predicate you want values for
	 * @param context
	 *            The {@link IRI} of the context of this statement
	 ...
	 * 
	 * @param value
	 *            The {@link Value} to store
	 * @param predicate
	 *            The predicate {@link IRI} of the property to set
	 * @param context
	 *            The {@link IRI} of the context
	 ...
	 * 
	 * @param value
	 *            The {@link Set} of {@link Value}s to set the property to
	 * @param predicate
	 *            The prediciate {@link IRI} of the property to set
	 * @param context
	 *            The context {@link IRI} to set the values for
	 */
	 ...
	 * 
	 * @param value
	 *            The {@link Value} to add
	 * @param predicate
	 *            The predicate {@link IRI} to add it to
	 * @param context
	 *            The context {@link IRI} to use
	 ...
	 *            The value to remove
	 * @param predicate
	 *            The predicate {@link IRI} to remove the {@link Value} from
	 * @param context
	 *            The context {@link IRI} to use
