...
import static com.mobi.persistence.utils.impl.SimpleBNodeService.BNODE_PREFIX;
...
public class SimpleBNodeServiceTest {
    ...
    private final IRI predicate = vf.createIRI("http://mobi.com/predicate");
    private final Resource subject = vf.createIRI("http://mobi.com/subject");
    private final Value object = vf.createIRI("http://mobi.com/object");
